...
if 0:
    ...
    dx1 = pd.concat(dd1)
    dx1.to_csv('uncertainty_inter-measure.cvs')
    dx2 = pd.concat(dd2)
    dx2.to_csv('uncertainty_inter-run.cvs')    
...
if 1:
    ...
    d1 = 1 - pd.read_csv('uncertainty_inter-measure.cvs', index_col=[0,1,2,3, 4,5])
    d2 = 1 - pd.read_csv('uncertainty_inter-run.cvs', index_col=[0,1,2,3, 4,5])
